...
local v15 = v14:CreateWindow({
    Title = "ManhBao Hub-Blox Fruit [ Free ]",-- thay tên bạn muốn đặt
    SubTitle = "By Tran Trương Manh Bao",-- tên bạn
    TabWidth = 160,
    Theme = "Dark",--màu
    Acrylic = false,
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://82068079123202") then --thay id ảnh vào
                    return v729;
                end
            end
        end
